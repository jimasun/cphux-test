        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <!-- Profile dropdown -->
                    <div x-data="{ isOpened: false }" class="relative ml-3">
                        <div>
                            <button type="button" x-on:click="isOpened = !isOpened"
                                class="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                                id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                <span class="sr-only">Open user menu</span>
                                <img class="h-8 w-8 rounded-full" src="http://www.gravatar.com/avatar?d=mm"
                                    alt="avatar">
                            </button>
                        </div>
                        <!--
                        ...
                        -->
                        <div x-show="isOpened" x-on:click.away="isOpened = false"
